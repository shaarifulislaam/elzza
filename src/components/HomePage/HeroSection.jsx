...
const HeroSection = () => {
  const listItems = [
    "17+ jaar ervaring",
    "Gecertificeerd en gegarandeerd",
        ...
        <div className="hero-container">
          <div className="hero-text-block">
            ...
            <h1 className="hero-title">
              <span>Stijlvolle, duurzame ramen en deuren </span>
              <span className="highlight">op maat gemaakt voor jou</span>
            </h1>
            <p className="desc">
              Ontdek duurzame, stijlvolle en energiezuinige oplossingen die het
              comfort en de schoonheid van jouw woning verbeteren — met
              vakmanschap, precieze installatie en betrouwbaarheid.
            </p>
            <div className="btn-container">
              <CommonBtn
                btnText="Vraag een gratis offerte aan"
                btnIcon={
                  <svg
