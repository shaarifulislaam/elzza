...
export const blogCards = [
  {
    id: "perfect-windows",
    title: "De Perfecte Ramen Kiezen voor de Stijl van Je Huis",
    date: "2025-10-04",
    excerpt:
      "Ontdek hoe je ramen kunt afstemmen op de architectuur van je huis voor tijdloze schoonheid en comfort.",
    image: "/assets/images/Homepage/inspiration/1.png",
    author: "Elzza Design Team",
    readTime: "4 min lezen",
    tags: ["ramen", "ontwerp", "huis"],
    href: "/blog/de-perfecte-ramen",
  },
  {
    id: "patio-doors",
    title: "Hoe Moderne Terrasdeuren Je Woonruimte Kunnen Verlichten",
    date: "2025-10-04",
    excerpt:
      "Leer hoe het juiste deurontwerp meer licht binnenbrengt, binnen- en buitenruimtes verbindt en de waarde van je huis verhoogt.",
    image: "/assets/images/Homepage/inspiration/2.png",
    author: "Home Interiors",
    readTime: "5 min lezen",
    tags: ["deuren", "terras", "renovatie"],
    href: "/blog/moderne-terrasdeuren",
  },
  {
    id: "energy-efficient",
    title: "Energiezuinig: Bespaar Geld en Blijf Comfortabel",
    date: "2025-10-04",
    excerpt:
      "Ontdek hoe energiezuinig glas en isolatie je huis gezelliger maken en je rekeningen het hele jaar door verlagen.",
    image: "/assets/images/Homepage/inspiration/3.png",
    author: "Duurzaam Leven",
    readTime: "6 min lezen",
    tags: ["energie", "glas", "besparing"],
    href: "/blog/energiezuinige-ramen",
  },
];
